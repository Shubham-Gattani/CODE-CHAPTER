...
class CollegeDetails(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    cc_id = db.Column(db.Integer, unique=True) # IMP
...
#     id = db.Column(db.Integer, primary_key=True)
#     student_id = db.Column(db.Integer, db.ForeignKey('students.id'), nullable=False)
#     term_code = db.Column(db.String(20), nullable=False)
    
#     # Registration details
#     registration_status = db.Column(db.String(20), default='pending')
#     fee_payment_status = db.Column(db.String(20), default='unpaid')
    
#     # Exam details
#     exam_centre = db.Column(db.String(255))
#     hall_ticket_number = db.Column(db.String(50))
